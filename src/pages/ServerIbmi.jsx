...
function ServerIbmi() {
  ...
  // Set default datetime window (5 mins)
  useEffect(() => {
    setSelectedDateTimes([dayjs().add(-5, 'm').format("YYYY-MM-DD HH:mm:ss"), dayjs().format("YYYY-MM-DD HH:mm:ss")])
  }, [])

  function handleDateTimes(newDateTimesValue) {
    console.log('ServerIbmi -> selectedDateTimes: ', newDateTimesValue)
    setSelectedDateTimes(newDateTimesValue)
  }
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="relative flex flex-col flex-1 overflow-x-hidden overflow-y-auto">
        ...
        {/*  Site header */}
        <Header sidebarOpen={sidebarOpen} setSidebarOpen={setSidebarOpen} handleDateTimes={handleDateTimes}/>

        <DateTimeWindowContext.Provider value={selectedDateTimes}>
          <main>
            <div className="w-full px-4 py-8 mx-auto sm:px-6 lg:px-8 max-w-9xl">
              ...
              <div className="inline-flex w-12 px-3 py-1 mb-4 text-xs font-semibold text-white uppercase rounded-full bg-sky-500">
        ...
        </DateTimeWindowContext.Provider>
      </div>
    </div>
  );
}
