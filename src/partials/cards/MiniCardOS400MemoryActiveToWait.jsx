...
function MiniCardOS400MemoryActiveToWait( { collectorHost, targetHost } ) {
  ...
  return (
    <React.Fragment>
      <div className="pt-5 border-b-2 grow">
        <h2 className="mb-2 text-sm font-semibold text-slate-800">Memory Pool Thread Transitions from Active to Wait</h2>
      </div>  
...
export default MiniCardOS400MemoryActiveToWait;
