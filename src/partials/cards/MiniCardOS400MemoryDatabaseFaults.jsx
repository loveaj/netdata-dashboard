...
function MiniCardOS400MemoryDatabaseFaults( { collectorHost, targetHost } ) {
  ...
  return (
    <React.Fragment>
      <div className="pt-5 border-b-2 grow">
        <h2 className="mb-2 text-sm font-semibold text-slate-800">Memory Pool Database Page Faults</h2>
      </div>  
...
export default MiniCardOS400MemoryDatabaseFaults;
