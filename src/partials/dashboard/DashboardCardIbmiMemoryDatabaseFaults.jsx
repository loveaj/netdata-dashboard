...
function DashboardCardIbmiMemoryDatabaseFaults({ collectorHost, targetHost }) {
  ...
  return (
    <div className="flex-initial border rounded-sm shadow-lg bg-stone-50 h-110 col-span-full sm:col-span-10 xl:col-span-10 border-slate-300">
      <div className="px-5 pt-5">
        ...
        <h2 className="mb-2 text-lg font-semibold text-slate-800">Memory Pool Database Page Faults</h2>
        <div className="mb-2 text-xs text-slate-600">
          The rate, in page faults per second, of database page faults against pages containing either database access paths or data.<br/>
        </div>
      </div>
...
export default DashboardCardIbmiMemoryDatabaseFaults;
