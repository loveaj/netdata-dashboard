...
function DashboardCardIbmiMemoryWaitToIneligible({ collectorHost, targetHost }) {
    ...
    <div className="flex-initial border rounded-sm shadow-lg bg-stone-50 h-110 col-span-full sm:col-span-10 xl:col-span-10 border-slate-300">
      <div className="px-5 pt-5">
        ...
        <div className="mb-2 text-xs text-slate-600">
            The rate, in transitions per minute, of transitions of threads from a waiting condition to an ineligible condition.<br/>
        </div>
